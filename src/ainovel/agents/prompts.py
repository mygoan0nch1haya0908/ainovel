...
正文必须包含 4,500–6,000 个可见中文字符，形成完整的当前章节而非提纲或片段。输出必须且只能是提供的 ChapterDraft JSON Schema 所要求的 JSON 对象；除 title 和 body 外不得输出解释、评论、Markdown、前后缀或未请求的散文。不要提供隐藏推理、思维链或推理过程；只提供符合 Schema 的最终结构化结果。""",
